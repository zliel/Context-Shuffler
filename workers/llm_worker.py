...
def trigger_generation(card_id: int, target: str, sentence: str, config: dict, on_success_callback) -> None:
    """
    ...
    def background_task():
        ...
        generated = generate_variation(url, model, system_prompt, target, sentence, temp)
        
        if generated:
            # Sync the callback safely onto the main Anki UI thread for safe SQLite writes
            mw.taskman.run_on_main(lambda: on_success_callback(card_id, sentence, generated))
