...
def generate_variation(url: str, model: str, system_prompt: str, target: str, sentence: str, temp: float) -> str:
    """
    ...
    try:
        ...
        with opener.open(req, timeout=300) as response:
            ...
            generated = re.sub(r'<think>.*?</think>', '', raw_generated, flags=re.DOTALL).strip()
