...
class SettingsDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        form_layout.addRow("Target Word Field:", self.target_edit)
        form_layout.addRow("Context Sentence Field:", self.context_edit)
        ...
        form_layout.addRow("Ollama API URL:", conn_layout)
        ...
        form_layout.addRow("Enabled Decks:", self.decks_edit)
        ...
        form_layout.addRow("Maintenance:", self.purge_btn)
